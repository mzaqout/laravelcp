            ...
            <div class="container">
                ...
                <div class="navbar-tools">
                    ...
                    <ul class="nav navbar-right">
                        ...
                        <li>
                            <a class="sb-toggle" href="#"><i class="fa fa-indent"></i></a>
                        </li>
                    ...
                    <ul class="main-navigation-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)"><i class="clip-user-2"></i>
                                <span class="title">حسابات المستخدمين</span><i class="icon-arrow"></i>
                                <span class="selected"></span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="/Admin/Users/users-list">
                                        <span class="title">عرض الحسابات</span>
                                    </a>
                                </li>
                                
                                <li>
                                    <a href="/Admin/Users/users-add">
